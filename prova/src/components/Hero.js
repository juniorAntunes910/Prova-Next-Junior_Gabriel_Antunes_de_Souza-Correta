...
export default function Hero() {
    //Hero padrão utilizado em todo site, possui tag link para tanto ir para o id cursos, tanto para ir para o about 
  return (
      ...
      <div className="mx-auto max-w-6xl px-4 py-16">
        <div className="max-w-3xl">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link
              href="#cursos"
              className="rounded-full bg-weg-blue px-5 py-3 text-sm font-bold bg-blue-800 text-white hover:bg-blue-900"
            >
              Explorar cursos
            </Link>
            <Link
