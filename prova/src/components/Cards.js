...
export default async function Cards() {
  ...
  try {
    //Aqui faça a requisição para pegar somente cursos
    ...
    console.log(eventos);
    //Preparo uma lista com evento e data formatada
    let eventosComData = [];
    //Faço a formatação da data, e adiciono tanto evento como dataFormatada na lista que foi preparada antes
    ...
    //Aqui utilizo a lista com evento e dataFormata para mostrar todos os dados 
    return (
      <>
