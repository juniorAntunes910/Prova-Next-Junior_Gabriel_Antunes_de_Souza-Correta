    ...
    <section className="mx-auto max-w-6xl px-4 py-14" id="cursos">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
        {cards.map((map) => (
          ...
          >
            <div className="h-44 bg-gray-200 animate-pulse w-full"></div>

            <div className="p-6">
              {/* Bloco do Título e Categoria */}
              <div className="flex justify-between mb-4">
                <div className="h-2 w-32 bg-gray-200 animate-pulse rounded"></div>
                <div className="h-1 w-16 bg-gray-100 animate-pulse rounded-full"></div>
              </div>
