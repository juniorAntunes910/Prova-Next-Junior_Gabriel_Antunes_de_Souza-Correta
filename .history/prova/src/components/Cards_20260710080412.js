    ...
    return (
      <>
        {eventos.map((evento) => (
          ...
          >
            <Image
              src="./assets/img/placeholder-curso.jpg"
            ...
            ></Image>
            <div class="p-5">
              <span class="inline-flex rounded-full bg-emerald-50 px-3 py-1 text-xs font-extrabold uppercase tracking-wide text-emerald-700">
                Destaque
              </span>
