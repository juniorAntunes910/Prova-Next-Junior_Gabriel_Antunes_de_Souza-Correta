          ...
          >
            ...
            <div className="p-5">
              ...
              <div className="mt-4 flex flex-wrap gap-2 text-xs font-bold text-slate-600">
                ...
                <span className="rounded-full bg-slate-100 px-3 py-1">
                  {`${eventoAtual.dataFormatada.diaSemana}/${eventoAtual.dataFormatada.mes}/${eventoAtual.dataFormatada.ano} às ${eventoAtual.dataFormatada.hora}:${eventoAtual.data.minutos}`}
                </span>
                <span
                  className={
