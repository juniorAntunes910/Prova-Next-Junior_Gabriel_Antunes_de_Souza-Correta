      ...
      <>
        {eventos.map((evento) => (
          ...
          >
            ...
            ></Image>
            <div class="p-5">
            <span  className= {evento.destaque ? "inline-flex rounded-full bg-emerald-50 px-3 py-1 text-xs font-extrabold uppercase tracking-wide text-emerald-700" : "hidden"}>
                Destaque
              </span>
