      ...
      <div className="mx-auto max-w-6xl px-4 py-16">
        <div className="max-w-3xl">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <a
              href="#cursos"
              className="rounded-full bg-weg-blue px-5 py-3 text-sm font-bold text-white hover:bg-weg-dark"
            >
              Explorar cursos
            </a>
            <a
              href="./sobre.html"
              class="rounded-full border border-slate-300 bg-white px-5 py-3 text-sm font-bold text-weg-dark hover:bg-slate-50"
            >
              Conhecer a WEG
            </a>
          </div>
